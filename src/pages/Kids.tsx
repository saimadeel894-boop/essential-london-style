...
import { getProductsByCollection, Product } from '@/lib/products';
...
const Kids = () => {
  const allKidsProducts = getProductsByCollection('kids');
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [allKidsProducts, selectedCategory, selectedSize, selectedPrice, sortBy]);
      ...
      <div className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-background/80 mt-4 max-w-md mx-auto">
            Premium streetwear designed for comfort and style, sized for ages 4-14
          </p>
        </div>
      </div>
